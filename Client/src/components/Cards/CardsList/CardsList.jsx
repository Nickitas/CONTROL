    ...
    if(back) {
      ...
      return (
        <section className={classes.CardsList}>
                                ...
                                >
                                  <TableCell padding="checkbox">
                                    ...
                                    />
                                      ...
                                      <TableCell align="right">{row.data_start}</TableCell>
                                      <TableCell align="right">{row.data_end}</TableCell>
                                      <TableCell align="right">{row.coment}</TableCell>
                                      <TableCell align="right">{row.num_link}</TableCell>
                                    </TableRow>
                                      );
                                  })}
                                  {emptyRows > 0 && (
          ...
          {visibleCreationCards&&<CreationCardsModal setVisibleCreationCards={setVisibleCreationCards}/>}
        </section>
    )
  }
}
