import { DB_RULES, DB_USER } from "../config/db.js"
...
export const getUsers = () => {
    let data = DB_USER.find()
    return data
}


export const getUser = (id) => {
    let data = DB_USER.findById(id)
    delete data.token
    return data
}
...
export const authUser = (obj, ip, callback) => {
    ...
    DB_USER.findOne({ login: obj.login, password: password, block: false }).then(async e => {
